...
fun FizzBuzzRequestEvent.toLogCreateCommand(fizzBuzzStatus: FizzBuzzStatus): LogCreateCommand = LogCreateCommand(
    this.ticket,
    this.user,
    this.inputNumber,
    this.packageName,
...
fun FizzBuzzRequestEvent.toDatabaseUpdateCommand(
    result: String?,
